/* Generated By:JavaCC: Do not edit this line. MixinParser.java */
package plp.mixin.parser;
...
import plp.mixin.memoria.ContextoCompilacaoMixin;
import plp.mixin.memoria.ContextoExecucaoMixin;
import plp.mixin.comando.*;
import plp.mixin.expressao.leftExpression.*;
import plp.mixin.declaracao.variavel.DecVariavelObjetoOO2;
import plp.mixin.util.ListaID;

/**
 * Parser para a Linguagem de Programaco Orientada a Objetos 2
 */
public class MixinParser implements MixinParserConstants {
  /**
  ...
  public static void main(String args [])
  {
    ...
    else if (args.length == 1)
    {
      ...
      try
      {
        parser = new MixinParser(new java.io.FileInputStream(args [0]));
      }
    ...
    else
    {
      ...
      System.out.println("         java MixinParser < inputfile");
    ...
    try
    {
      ...
      if (programa.checaTipo(new ContextoCompilacaoMixin(new ListaValor())))
      {
        programa.executar(new ContextoExecucaoMixin());
      }
      else
      {
...
/*
 * A partir de agora, serao expostos atraves desse tipo de comentario
...
**/
  final public ListaDeclaracaoOO PListaDeclaracaoOO() throws ParseException {
    ...
    if (jj_2_36(2147483647)) {
      ...
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case CATEGORIA:
        decCategoria = PDecCategoriaAtomica();
        retorno = new ListaDeclaracaoOO(decCategoria);
        break;
      default:
        jj_la1[18] = jj_gen;
        jj_consume_token(-1);
...
/**
 * DecCategoria ::= "categoria" Id "{" DecProcedimento "}"
 **/
  final public DecCategoriaSimples PDecCategoriaAtomica() throws ParseException {
  Id nome;
  DecProcedimento metodos;
    jj_consume_token(CATEGORIA);
    nome = PId();
    jj_consume_token(LBRACE);
    metodos = PDecProcedimento();
    jj_consume_token(RBRACE);
                                {if (true) return new DecCategoriaSimples(nome, metodos);}
    throw new Error("Missing return statement in function");
  }
 ...
 * ...  | DecCategoria "," ListaDeclaracaoOO
 **/
  final public ListaDeclaracaoOO PDecCategoriaComposta() throws ParseException {
  DecCategoriaSimples d1;
  ListaDeclaracaoOO d2;
    d1 = PDecCategoriaAtomica();
    jj_consume_token(COMMA);
...
/**
 * DecClasse ::= "classe" Id ["extends" Id] ["mixin" ListaId] "{" DecVariavel ";" DecConstrutor ";" DecProcedimento "}"
 **/
  final public DecClasse PDecClasseAtomica() throws ParseException {
  Id nomeClasse;
  Id superClasse = null;
  ListaID categoria = null;
  ...
  DecClasse resposta;
    if (jj_2_39(2147483647)) {
      ...
      metodos = PDecProcedimento();
      jj_consume_token(RBRACE);
                                resposta = new DecClasseSimplesOO2(nomeClasse, superClasse, categoria, atributos, decConstrutor, metodos);
 ...
 **/
  ...
  ListaID id2;
    ...
    jj_consume_token(COMMA);
    id2 = PListaID();
    {if (true) return new ListaID(id1, id2);}
    throw new Error("Missing return statement in function");
  }
  ...
  private boolean jj_3R_16() {
    if (jj_scan_token(CATEGORIA)) return true;
  ...
  public MixinParserTokenManager token_source;
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x23b0000,0x0,0x200000,0x2000000,0x12007800,0x2000000,0x80000,0x10006000,0x0,0x2000,0x12007800,0x0,0x400,0x400,0x200,0x0,0x2000000,0x0,0x8000000,0x0,0x0,0x0,0x20000000,0x20000000,0x0,0x0,0x0,0x0,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x2900,0x800,0x0,0x900,0x988,0x900,0x0,0x88,0x80,0x0,0x988,0x10000000,0x0,0x0,0x0,0x900,0x0,0x100,0x0,0x907,0x100,0x107,0x0,0x0,0x107,0x100,0x4,0x100,};
   }
   private static void jj_la1_init_2() {
      jj_la1_2 = new int[] {0x0,0x0,0x0,0x0,0x10,0x0,0x0,0x0,0x0,0x0,0x10,0x0,0x1c,0x1c,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,};
   }
  ...
  public MixinParser(java.io.InputStream stream) {
     this(stream, null);
  }
  /** Constructor with InputStream and supplied encoding */
  public MixinParser(java.io.InputStream stream, String encoding) {
    try { jj_input_stream = new JavaCharStream(stream, encoding, 1, 1); } catch(java.io.UnsupportedEncodingException e) { throw new RuntimeException(e); }
    token_source = new MixinParserTokenManager(jj_input_stream);
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  /** Constructor. */
  public MixinParser(java.io.Reader stream) {
  ...
  public MixinParser(MixinParserTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  /** Reinitialise. */
  public void ReInit(MixinParserTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
